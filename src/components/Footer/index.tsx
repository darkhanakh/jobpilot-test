...
const footerData = [
  {
    title: "Quick Links",
    elements: ["About Us", "Contact", "Pricing", "Blog"],
  },
  {
    title: "Candidate",
    elements: [
  ...
  {
    title: "Support",
    elements: ["Faqs", "Privacy Policy", "Terms & Conditions"],
  },
];

const FooterColumn: React.FC<FooterColumnProps> = ({ title, elements }) => {
  return (
    <div className="mr-16">
      <h2 className="mb-6 font-semibold text-white text-lg">{title}</h2>
      ...
      <div className="md:flex md:justify-between">
        <div className="mb-6 md:mb-0 flex flex-col">
          ...
          <span className="text-gray-400 text-sm">
            6391 Elgin St. Celina, Delaware 10299, New York, <br /> United
            States of America
          </span>
        </div>
